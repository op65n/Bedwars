package frosty.op65n.tech.bedwars.util.gui.menu.impl;

import frosty.op65n.tech.bedwars.util.gui.components.type.ScrollType;
...
public final class ScrollingGui extends PaginatedGui {
    ...
    /**
     * Overrides {@link PaginatedGui#open(org.bukkit.entity.HumanEntity)} to make it work with the specific scrolls
     *
